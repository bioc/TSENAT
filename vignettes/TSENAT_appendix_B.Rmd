...
**Method 1: Generalized Additive Mixed Models (GAMM)** with functional q-curve structure (full details in the main vignette).
...
- Paired fits: `nlme::lme` with `ns(q, df = 3) × condition`, subject random intercepts, and an AR(1) working correlation within subject × condition (`nlme::corAR1()`; validated by Monte Carlo simulation); the interaction is tested with a marginal F-test.
