...
- **Effect Size**: Proportion of variance in entropy explained by the fitted model, ranging from 0 to 1 (deviance explained for GAM paths; model pseudo-R² for the paired regression-spline path). Larger values indicate stronger scale-dependent effects, but note that this deviance/R² scale differs from classical η² and does not share the same interpretive thresholds (Cohen's conventions for η² do not directly apply).
