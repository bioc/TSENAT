...
**Interpretation:** TRUE in the Heteroscedasticity column indicates that variance heterogeneity was detected across the q-spectrum (assumption violated, results warrant caution); FALSE indicates homoscedasticity (variance homogeneity assumption satisfied).
