...
context("SAIT Interaction: FPCA Methods")
...
test_that("fpca method attaches p_interaction to rowData", {
    ...
    res <- TSENAT:::.calculate_sait(se, condition_col = "sample_type", method = "fpca", min_obs = 2)
...
context("SAIT Interaction: FPCA with prcomp and Error Handling")
...
# ============================================================================
# Additional FPCA tests (moved from test-statistical-methods-sait_helpers.R)
# ============================================================================
...
test_that(".fpca_interaction works with all regularization methods", {
    ...
    res_pca <- TSENAT:::.calculate_sait(se,
...
# ============================================================================
# FPCA regularization methods (moved from legacy statistical methods tests)
# ============================================================================
...
test_that("FPCA with regularization='pca' (default) works correctly", {
    ...
    res_default <- TSENAT:::.calculate_sait(se,
        condition_col = "sample_type",
        method = "fpca",
        min_obs = 2
    )
...
test_that("FPCA with regularization='lasso' produces valid results", {
    ...
    res_lasso <- TSENAT:::.calculate_sait(se,
        condition_col = "sample_type",
        method = "fpca",
        regularization = "lasso",
        min_obs = 2
...
test_that("FPCA with regularization='elasticnet' produces valid results", {
    ...
    res_elasticnet <- TSENAT:::.calculate_sait(se,
        condition_col = "sample_type",
        method = "fpca",
        regularization = "elasticnet",
        min_obs = 2
